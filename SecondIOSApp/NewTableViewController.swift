...
class NewTableViewController: UITableViewController {
    ...
    //TableViewControllers inherit methods that allows them to define what the TableViewController looks like
    //This method defines the number of sections the TableViewController will have
    ...
    //It gets called the same number of times as there are rows in each position
    //The indexPath object is a Swift struct that encapsulates the section of each cell and the row of each cell (0, 0), (0, 1), (0, 2), (0, 3)
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MonsterCell", for: indexPath)

        // Configure the cell...
        //the cell has a textLabel (Title), imageView, and a detailTextLabel (Subtitle) object
